...
{
    public partial class sellerPassReset : Form
    {
        ...
        public sellerPassReset( string phone ,string username)
        {
            InitializeComponent();
            this.FormClosing += new FormClosingEventHandler(sellerPassReset_FormClosing);
            this.userPhoneNo = phone;
            this.username = username;
        }
        private void sellerPassReset_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void sellerPassReset_Load(object sender, EventArgs e)
        {
        ...
        private string UpdatePasswordInDatabase(string newPassword)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                string query = "UPDATE sellerInfo SET password = @password WHERE (username = @username OR email = @email) AND mobileNo = @mobileNo";
                ...
                command.Parameters.AddWithValue("@mobileNo", userPhoneNo);     // The phone number of the logged-in user
